                        ...
                        <span class="h3 mb-0 text-white">
                          ...
                          if ($user_role === 'cashier') {
                            $query = "
                                ...
                                FROM orders
                                WHERE order_date = '$current_date' AND user_id = '$user_id'
                            ";
                          } else {
                          ...
                          echo "<span class='h3 mb-0 text-white'>" . number_format($total) . "</span>";
                          ?>
                        </span>
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col pr-0">
                        ...
                        <span class="h3 mb-0">
                          ...
                          $result = mysqli_query($dbc, $query);
                          $row = mysqli_fetch_assoc($result);
                          $total_orders = isset($row['total_orders']) ? $row['total_orders'] : 0;
                          echo $total_orders;
                          ?>
                        </span>
                      </div>
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col pr-0">
                        ...
                        <span class="h3 mb-0 text-white">
                          <?php
                          if ($fetchedUserRole === 'admin') {
                            @$total_purchase = mysqli_fetch_assoc(mysqli_query($dbc, "
                              SELECT SUM(grand_total) as total_sales 
                              FROM purchase 
                ...
                <div class="card shadow border-0">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col pr-0">
                        <p class="small text-muted mb-0">Today Purchases Count</p>
                        <span class="h3 mb-0">
                          <?php
                          if ($fetchedUserRole === 'admin') {
              ...
              <div class="col-md-6">
                <div class="card shadow eq-card mb-4">
                  <div class="card-body">
                    ...
                    <div class="row mt-b">
                      <?php
                      // Get user ID if role is cashier
                      $user_filter = ($fetchedUserRole === 'cashier') ? " AND user_id = '$user_id'" : "";
                      ?>
                      ...
                      <div class="col-6 text-center mb-3 border-right">
                        ...
                        <h6 class="mb-1">
                          <?php
                          echo getOrders($dbc, "WHERE order_date = '$current_date' $user_filter", "grand_total");
                          ?>
                        </h6>
                      </div>
                      ...
                      <div class="col-6 text-center mb-3">
                        ...
                        <h6 class="mb-1">
                          <?= getOrders($dbc, "WHERE order_date = '$yesterday_date' $user_filter", "grand_total") ?>
                        </h6>
                      </div>
                      ...
                      <div class="col-6 text-center border-right">
                        ...
                        <h6 class="mb-1">
                          <?= getOrders($dbc, "WHERE order_date BETWEEN '$last_start_week' AND '$last_end_week' $user_filter", "grand_total") ?>
                        </h6>
                      </div>
                      ...
                      <div class="col-6 text-center">
                        ...
                        <h6 class="mb-1">
                          <?= getOrders($dbc, "WHERE order_date BETWEEN '$start_week' AND '$end_week' $user_filter", "grand_total") ?>
                        </h6>
                      </div>
                    </div>
