                        ...
                        <main>
                            <div class="row contacts">
                                <div class="col invoice-to">
                                    <div class="text-gray-light font-weight-bolder h3">CUSTOMER'S DETAILS:</div>
                                    <h1 class="to"><?= ucwords($order['client_name']) ?></h1>
                                    <div class="font-weight-bolder" style="font-size: 22px"><?= @$order['client_contact'] ?></div>
                                    <div class="font-weight-bolder" style="font-size: 22px">Bill #<?= @$order['supplier_bill_number'] ?></div>
                            ...
                            <div
                                <?php if ($_REQUEST['type'] == "order" && $order['payment_type'] == "credit_sale"): ?>
                            ...
                            <?php if ($order['payment_type'] == "credit_sale"): ?>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="notices">
                                            <h5><strong>Thank you! for choosing <b class="name"><?= $get_company['name'] ?></b></strong></h5>
