...
<body class="horizontal light  ">
  <div class="wrapper">
    ...
    <main role="main" cla ss="main-content">
              ...
              <tbody>
                ...
                while ($r = mysqli_fetch_assoc($q)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <!-- <a target="_blank" href="stock.php?type=amount&category=<?= $r['categories_id'] ?>"
                        class="btn btn-admin2  btn-sm mx-1">Print Stock With Amount</a>
                      <a target="_blank" href="stock.php?type=amount&category=<?= $r['categories_id'] ?>&stock=0"
                        class="btn btn-admin  btn-sm mx-1">Print Stock With Amount + AQ</a> -->
                      <a target="_blank" href="stock.php?type=simple&category=<?= $r['categories_id'] ?>"
                        class="btn btn-admin2  btn-sm mx-1">Print Stock</a>
