          ...
          <form action="php_action/custom_action.php" method="POST" id="sale_order_fm">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-2">
                ...
                <input type="text" name="next_increment" id="next_increment"
                  ...
                  readonly class="form-control" placeholder="Auto-generated ID">
              </div>
              ...
              <!-- Bill Number (New Field) -->
              <div class="col-md-2">
                <label>Bill Number</label>
                <input type="text" name="supplier_bill_number" id="supplier_bill_number"
                  value="<?= @$fetchPurchase['supplier_bill_number'] ?>" class="form-control"
              ...
              <div class="col-md-3">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <a href="customers.php?type=supplier" class="btn btn-admin2 btn-sm">Add Supplier</a>
                </div>
                <div class="input-group mt-1">
                  <select class="form-control" name="cash_purchase_supplier" id="credit_order_client_name" required
                    onchange="getBalance(this.value,'customer_account_exp')" aria-label="Supplier"
            ...
            ");
              ...
              <div class="col-md-3">
                ...
                <input type="text" value="<?= @$fetchPurchase['purchase_narration'] ?>" autocomplete="off"
                  class="form-control" name="purchase_narration" placeholder="Optional Notes">
              </div>
            </div>
            ...
            <div class="form-group row align-items-end">
              <div class="col-12 col-sm-6 col-md-2 mb-2">
                ...
                <input type="text" placeholder="Scan or enter barcode" name="product_code" autocomplete="off"
              ...
              <div class="col-12 col-sm-6 col-md-2 mb-2">
                ...
                <input type="number" min="0" class="form-control price-input" id="get_product_price"
                  placeholder="Enter purchase rate" step="0.01">
              </div>

              <div class="col-12 col-sm-6 col-md-2 mb-2">
                <label for="get_sale_price">Sale Rate</label>
                <input type="number" min="0" <?= ($_SESSION['user_role'] == "admin") ? "" : "readonly" ?>
                  class="form-control" id="get_sale_price" placeholder="Enter sale rate" step="0.01">
              </div>

              <div class="col-12 col-sm-6 col-md-2 mb-2">
                <label for="get_product_quantity">Quantity</label>
                <input type="number" class="form-control" id="get_product_quantity" value="0" min="0" name="quantity"
                      ...
                      while ($r = mysqli_fetch_assoc($q)) {
                        ...
                        <tr id="product_idN_<?= $r['product_id'] ?>">
                          ...
                          <td>
                            ...
                            <button type="button"
                              onclick="editByid(<?= $r['product_id'] ?>, '<?= ucwords($r['product_code']) ?>', <?= $r['rate'] ?>, <?= $r['quantity'] ?>)"
                  ...
                  <tfoot>
                    ...
                    <tr>
                      ...
                      <td class="table-bordered">
                        <div class="input-group input-group-sm">
                          ...
                          <input type="number" id="ordered_discount" name="ordered_discount" class="form-control"
                            value="<?= @$fetchPurchase['discount'] ?>" min="0" placeholder="Enter discount"
                    ...
                    <tr>
                      ...
                      <td class="table-bordered">
                        <div class="input-group input-group-sm">
                          <span class="input-group-text py-0">Rs</span>
                          <input type="number" class="form-control" id="paid_ammount" name="paid_ammount"
                            value="<?= @$fetchPurchase['paid'] ?>" min="0" placeholder="Enter paid amount"
                            onkeyup="getRemaingAmount()" required>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td class="table-bordered">
                        <div class="input-group input-group-sm">
                          <span class="input-group-text py-0">Rs</span>
                          <input type="number" class="form-control form-control-sm" id="remaining_ammount"
                            name="remaining_ammount" value="<?= @$fetchPurchase['due'] ?>" readonly
                      ...
                      <td class="table-bordered">
                        <div class="input-group">
                          <select class="form-control" name="payment_account" id="payment_account"
                            onchange="getBalance(this.value,'payment_account_bl')" aria-label="Payment Account"
                            ...
                            while ($r = mysqli_fetch_assoc($q)):
                              ...
                              $isSelected = '';
                              if (!empty($fetchPurchase['payment_account'])) {
                                // Edit Mode
